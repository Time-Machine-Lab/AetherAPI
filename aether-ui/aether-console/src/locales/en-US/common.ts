export default {
  ...
  console: {
    ...
    workspace: {
      ...
      fieldAsyncTaskQueryResponseJsonSchema: 'Task query response JSON Schema',
      fieldAsyncTaskQueryResponseJsonSchemaHint:
        'Optional upstream task-query response body schema snapshot. It is display metadata and does not change passthrough task-query results.',
