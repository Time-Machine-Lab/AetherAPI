# console-platform-proxy-asset-candidate-select Specification

## Purpose
TBD - created by archiving change add-platform-proxy-asset-candidate-select. Update Purpose after archive.
## Requirements
