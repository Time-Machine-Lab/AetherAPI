# console-import-agent-upstream-headers Specification

## Purpose
TBD - created by archiving change add-console-api-asset-upstream-headers. Update Purpose after archive.
## Requirements
