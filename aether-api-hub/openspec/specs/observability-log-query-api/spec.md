# observability-log-query-api Specification

## Purpose

Define the developer-console-facing API call log query experience so authenticated users can list and inspect only their own invocation records without exposing explicit Consumer management behavior.
