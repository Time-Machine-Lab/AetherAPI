# asset-management-list-api Specification

## Purpose

Define management-facing asset list endpoint requirements for paged asset browsing across lifecycle states, supporting basic management filters and returning operator-readable summary fields.
