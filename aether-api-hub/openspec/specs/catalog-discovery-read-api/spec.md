...
Define the read-only discovery experience for API marketplace browsing so callers can list and inspect enabled API assets without depending on write-model internals.
