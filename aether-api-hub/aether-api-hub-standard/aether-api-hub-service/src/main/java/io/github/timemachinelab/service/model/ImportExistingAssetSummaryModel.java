...
/**
 * Safe summary of an existing owner-scoped asset for import-agent planning.
 */
public class ImportExistingAssetSummaryModel {
    ...
    public ImportExistingAssetSummaryModel(
            String apiCode,
            String assetName,
            String assetType,
            String categoryCode,
