...
public interface ApiCategoryRepository {
     ...
     */
    Optional<io.github.timemachinelab.domain.catalog.model.ApiCategoryAggregate> findByCode(CategoryCode code);
     ...
     * @return 分类聚合根（如果存在）
     */
    Optional<io.github.timemachinelab.domain.catalog.model.ApiCategoryAggregate> findByCodeIncludingDeleted(CategoryCode code);
     ...
     * @return 分类聚合根列表
     */
    List<io.github.timemachinelab.domain.catalog.model.ApiCategoryAggregate> findAll(CategoryStatus status, int page, int size);
     ...
     */
    void save(io.github.timemachinelab.domain.catalog.model.ApiCategoryAggregate aggregate);
}
