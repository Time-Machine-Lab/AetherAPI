    ...
    private static ImportCategoryPlanModel mergeCategoryPlan(JsonNode categoryNode, ImportCategoryPlanModel currentCategoryPlan) {
        return new ImportCategoryPlanModel(
                ...
                ImportAgentPlannerJsonSupport.hasField(categoryNode, "action")
                        ? ImportAgentPlannerJsonSupport.enumValue(ImportCategoryPlanAction.class, ImportAgentPlannerJsonSupport.textValue(categoryNode, "action"), null)
                        : ImportAgentPlannerJsonSupport.currentValue(currentCategoryPlan, ImportCategoryPlanModel::getAction));
    }
